...
// TODO editing stopped here


Perform the same measurements of section 2.2.
​2.4.​ Measure input currents and offset voltage
Place a 10k resistor in series with the bases of each of Q1 and Q2.  Use the Keysight multimeters to obtain an accurate measurement of the actual values of these resistors.
Set Vicm = 0 V  and Vid = 0 V using the function generators.
Measure the base currents of Q1 and Q2.
                                                Ib1 = _______________________________

                                                Ib2 = _______________________________
Measure the DC base-emitter voltages of Q1 and Q2 as accurately as you can.
                                                VBE1 = _____________________________
                                                VBE2 = _____________________________
Separately, accurately measure the difference between the Q1 and Q2 base voltages (do not subtract the previous values mathematically!)
                                                (Vina - Vinb) = ______________________
