...
image::fig/bias-stability-lab2a.svg[]
...
Use the `LCR-T4 semiconductor + LCR tester` to measure each transistor's forward &beta;~F~ and the V~BE~ at the measurement conditions.
