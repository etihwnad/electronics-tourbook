...
Clearly write out your mathematical circuit analysis of the following for your specific lab circuit and power supplies:
...
* [ ] Estimate your amplifier's output resistance stem:[R_{out}], again not merely the CE amplifier's stem:[Z_{out}].  In all cases, ignore stem:[r_o] by replacing it with an open circuit.
