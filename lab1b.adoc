...
image::current-mirror-lab1b.svg[width=90%]
...
Your task is to learn about the concepts using <<f-current-mirror>> as your example and describe your findings to your classmates who did the other activity.
...
Begin with the circuit of <<f-current-mirror>> for your analysis.

Set source `Vs` to zero (replace with a wire to the ground node, or set the
waveform generator to _actively_ output 0 V DC).
