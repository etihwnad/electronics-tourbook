...
Then modify this system to reliably detect an on/off modulated ultrasonic signal from as far away as possible.



== Description

* 2 V~p-p~ output at 2m distance
...
=== Gain-bandwidth product notes

* https://drive.google.com/open?id=1pB0ZeH7VQOaIpxDoqxLKYlY9qQTggykt[Notes: One-pole amplifiers, gain-bandwidth product, frequency response, and you^]
...
* https://drive.google.com/open?id=1UH_vMMAfWeOtUDUYZoN6d__3YPAZXkTG[Notes: Cascaded amplifiers^]


* https://agnd.net/valpo/341/guidebook/cascaded-amplifiers.html[Animations of gain-bandwidth trade-off and cascaded amplifiers^]
