...
* [ ] Measure the resulting DC bias point.  Does the collector current stay the same?  What about V~OUT~?


* [ ] Finally, measure the signal gain v~out~ / v~in~ at frequencies of 100 Hz, 1 kHz, and 10 kHz.
